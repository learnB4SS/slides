...
We are going to talk about some diagnostics like Rhat and effective sample size, as well as best practices for assessing chains, and correcting for divergent transitions

The purpose of this session is to help you build intuition about how to know when your model is poor, and luckily BRMS makes that quite easy to do
...
She travels around the kingdom solving mysteries and I think this is a bit similar to what it's like, especially at first when doing model assessment
...
Now we're going to talk about Rhat and effective sample size

You probably noticed over the course of the last two days that when we examine summary of a brms model we see something like this...
...
You may also have noticed these three columns on the right-hand side: Rhat, bulk ESS and tail ESS

What is all this about?

Rhat is a convergence diagnostic that compares estimate between and within chains (more on chains in a bit)
