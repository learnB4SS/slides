...
# Prior belief as probability distribution
...
The post distr is (roughly) the combination of the prior belief about the variable and the evidence derived from the data (remember Bayes Theorem).
